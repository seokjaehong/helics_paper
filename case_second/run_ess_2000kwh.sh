...
CASE_TYPE=2000kwh python solar_fed.py &
SOLAR_PID=$!

echo "   - ESS 페더레이트 시작 (2000kWh)..."
CASE_TYPE=2000kwh ESS_CAPACITY=2000 python ess_fed.py &
ESS_PID=$!

echo "   - OpenDSS 페더레이트 시작..."
CASE_TYPE=2000kwh python opendss_fed.py &
DSS_PID=$!
...
echo "✅ ESS 2000kWh 완료! 결과는 case_second/data/case2000kwh/ 폴더에 저장되었습니다."
