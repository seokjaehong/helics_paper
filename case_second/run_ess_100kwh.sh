...
CASE_TYPE=100kwh python solar_fed.py &
SOLAR_PID=$!

echo "   - ESS 페더레이트 시작 (100kWh)..."
CASE_TYPE=100kwh ESS_CAPACITY=100 python ess_fed.py &
ESS_PID=$!

echo "   - OpenDSS 페더레이트 시작..."
CASE_TYPE=100kwh python opendss_fed.py &
DSS_PID=$!
...
echo "✅ ESS 100kWh 완료! 결과는 case_second/data/case100kwh/ 폴더에 저장되었습니다."
