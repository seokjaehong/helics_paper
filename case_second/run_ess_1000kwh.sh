...
CASE_TYPE=1000kwh python solar_fed.py &
SOLAR_PID=$!

echo "   - ESS 페더레이트 시작 (1000kWh)..."
CASE_TYPE=1000kwh ESS_CAPACITY=1000 python ess_fed.py &
ESS_PID=$!

echo "   - OpenDSS 페더레이트 시작..."
CASE_TYPE=1000kwh python opendss_fed.py &
DSS_PID=$!
...
echo "✅ ESS 1000kWh 완료! 결과는 case_second/data/case1000kwh/ 폴더에 저장되었습니다."
